...
def ongoing_event_text_adjust(Cat, text, clan=None, other_clan_name=None):
    ...
    text = text.replace("c_n", clan_name + "'s Troop")
...
def leader_ceremony_text_adjust(Cat,
    ...
    text = text.replace("c_n", str(game.clan.name) + "'s Troop")
...
def ceremony_text_adjust(Cat,
                         ...
                         living_parents=(),
                         dead_parents=()):
    clanname = str(game.clan.name + "'s Troop")
...
def generate_sprite(cat, life_state=None, scars_hidden=False, acc_hidden=False, always_living=False, 
    ...
    try:
        ...
        # draw maskgloves
        if cat.pelt.maskgloves is not None:
            new_sprite.blit(sprites.sprites["maskgloves" + cat.pelt.maskgloves + cat_sprite], (0, 0))
