...
class Pelt():
    ...
    tortiebases = ['single', 'tabby', 'bengal', 'marbled', 'ticked', 'smoke', 'rosette', 'speckled', 'mackerel',
                'tapir', 'sokoke', 'agouti', 'singlestripe']
    ...
    def init_antlers(self, parents) -> bool:
        ...
        if parents:
            ...
            if len(par_antlers) == 0:
                ...
                print("Error - no parents. Randomizing antlers.")
                random.choice(self.antler_types)
                return
            else:
        ...
        self.antlers = random.choice(self.antler_types)
            ...
            if self.colour:
                ...
                if not wildcard_chance or random.getrandbits(wildcard_chance) == 1:
                    ...
                    if self.tortiebase in ["singlestripe", "smoke", "single"]:
                        self.tortiepattern = choice(['tabby', 'mackerel', 'tapir', 'single', 'smoke', 'agouti',
                                                    'ticked'])
                    else:
